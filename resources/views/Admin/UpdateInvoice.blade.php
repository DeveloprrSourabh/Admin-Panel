...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
      ...
      <x-header/>
         ...
         <div
            ...
            <div
               ...
               <!-- End of Topbar -->
               <div class="in_form">
                  @foreach($editin as $edit)
                  <?php
                     $id = $_GET['inid'];
   if ($edit['invoicenum']==$id) {
       echo '
                        <div class="container">
                        <form id="invoice-form" action="'.route("edit.invoice").'" method="post"  enctype="multipart/form-data">
                       '.@csrf_field().'
                            ...
                            <div
                                ...
                                <div class="col-12 in_col1">
                                    ...
                                    <div class="inv_number">
                                        ...
                                        <input   value="'.$edit["invoicenum"].'"  type="hidden" class="form-control form-control-user" placeholder="Employee id" id="exampleInputempl_id" name="empl_id">
                                        <hr>
                                ...
                                <div class="col-12  in_col1">
                                    ...
                                    <div class="inv_number">
                                        <input value="'.$edit["invoicedate"].'"  type="date" name="invoicedate" placeholder="Enter Invoice Date" class="  inv_num_detail" />
                                        <hr>
                                    </div>
                                </div>
                                <!-- Due date -->
                                <div class="col-12 in_col1">
                                    ...
                                    <div class="inv_number">
                                        <input value="'.$edit["duedate"].'"   type="date"  name="duedate" placeholder="Enter Due Date" class=" inv_num_detail" />
                                        <hr>
                                    </div>
                                </div>
                                    ...
                                    <div
                                                ...
                                                <div class="buisness_detail">
                                                    <div class="container">
                                                        ...
                                                        <div class="row mb-5 mr-5">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="b_namev">
                                                                    <input  value="'.$edit["business"].'"  name="business" placeholder="Enter Business" class=" inv_num_detail" /></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3 mr-5">
                                                            ...
                                                            <div class="col-6">
                                                            <div class="b_namev">
                                                                <input value="'.$edit["adress"].'"   name="adress" placeholder="Enter Adress" class=" inv_num_detail" /></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3 mr-5">
                                                            ...
                                                            <div class="col-6">
                                                            <div class="b_namev">
                                                                <input value="'.$edit["gstin"].'"   name="gstin" placeholder="Enter GSTIN" class=" inv_num_detail" /></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="containers">
                                                ...
                                                <div class="input_bill">
                                                    <input value="'.$edit["billedto"].'"   name="billedto" class="  b_input" type="text" placeholder="Select a Client">
                        ...
                        <div class="table mt-5 pt-2">
                            <div class="container">
                                <table class="container">
                                    ...
                                    <tr>
                                        <td>
                                            <input value="'.$edit["item"].'"   name="item" class="input_table"  placeholder="Item name (Required)" type="text">
                                        </td>
                                        <td>
                                            <input value="'.$edit["gstrate"].'"   name="gstrate" class="table_input " type="number">
                                        </td>
                                        <td>
                                            <input value="'.$edit["quantity"].'"   name="quantity" class="table_input " type="number">
                                        </td>
                                        <td>
                                            <input value="'.$edit["rate"].'"   name="rate" class="table_input " type="number">
                                        </td>
                                        <td>
                                            <input value="'.$edit["amount"].'"   name="amount" class="table_input " type="number">
                                        </td>
                                        <td>
                                            <input value="'.$edit["igst"].'"   name="igst" class="table_input " type="number">
                                        </td>
                                        <td>
                                            <input value="'.$edit["total"].'"   name="total" class="table_input " type="number">
                                        </td>
                                    </tr>
                        ...
                        <div class="container btn-save my-4  mx-auto">
                            <button id="editbtn" type="button" class="btn btn_save btn-primary">Save Details</button>
                        </div>
                        </form>
   ...
   ?>
      ...
      <script src="js/demo/chart-area-demo.js"></script><script src="js/demo/chart-pie-demo.js"></script>
      <!-- Edit invoice form -->
